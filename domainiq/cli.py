...
Examples:
  ...
  domainiq --monitor-list
    ...
    parser.add_argument(
        "--email-alert", action="store_true", help="Enable email alerts for monitor"
    )
    parser.add_argument(
        "--add-monitor-item",
        nargs=3,
        ...
        if hasattr(result, "__dict__"):
            ...
            for key, value in result_dict.items():
                if hasattr(value, "isoformat"):
                    ...
                    isinstance(value, list) and value and hasattr(value[0], "__dict__")
                ):
        ...
        with DomainIQClient(config) as client:
            ...
            # Monitor management
                ...
                result = client.create_monitor_report(
                    report_type, name, email_alert=args.email_alert
                )
                print_result(result)
                ...
                result = client.add_monitor_item(int(report_id), item_type, items_list)
                print_result(result)
