...
from domainiq._params.queue import build_queue_params
from domainiq.cli._args import create_parser
from domainiq.cli._dispatch import _dispatch_queue
from domainiq.cli._handlers import handle_queue
from domainiq.cli._types import QueueArgs
...
class TestQueueCli:
    ...
    def test_dispatch_noop_when_absent(self) -> None:
        client = StubClient()
        args = argparse.Namespace(queue_hash=None, queue_action=None)
        result = _dispatch_queue(cast("QueueProtocol", client), args)
